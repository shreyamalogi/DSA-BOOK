...
void fact(int n)
{
	...
	v.push_back();  //push 1 into the vector initially
	...
	for(int j=i; j<v.size(); i++) cout<<v[j]; //basically we will be outputing all the digits but inorder to find digits, declare digits func as multiply
